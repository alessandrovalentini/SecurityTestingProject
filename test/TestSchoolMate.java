...
public class TestSchoolMate {
	...
	@Test
		...
		tester.clickLinkWithText(""); // course name
		tester.assertMatch("Class Settings");
		tester.clickLinkWithText("Assignaments");
		
		tester.assertMatch("Manage Assignaments");
		tester.setHiddenField("page2", "<a href=\"http://www.google.it\">malicious link</a> <br' "); //malicious link
		...
		String newValue = "document.assignament.submit()";
...
//-----------------------------------------------------------------------------
	...
	public void testVulnerability41(){
        ...
        tester.clickButtonWithText("Add New Class");
        tester.assertMatch("Edit Class");
        tester.setTextField("title", "<a href=as.it>T");
        tester.setTextField("message", "<a href='http://www.microsoft.com/'>Malicious link</a>");
	...
	public void testVulnerability54() {
		...
		tester.assertMatch("Manage School Informadmination");
	...
	public void testVulnerability87(){
		...
		tester.assertLinkPresentWithText("Class Settings");
        tester.assertCheckboxPresent("delete[]", "3");
        tester.clickButtonWithText("Edit");
        tester.assertMatch("Edit Semesters");
        tester.setTextField("title", "<a href=as.it>S");
	...
	public void testVulnerability92(){
		...
		tester.clickLinkWithText("School");
		tester.assertMatch("Manage Classes");
		tester.setTextField("schoolname", "<a href=\"http://www.microsoft.com/\">Malicious link 1</a>"); //max 50 chars
		tester.setTextField("schooladdress", "<a href=\"http://www.microsoft.com/\">Malicious link 2</a>"); //max 50 chars
		tester.setTextField("schoolphone", "<a href=3.it>3"); //max 14 chars
		tester.setTextField("sitetext", "<a href=\"http://www.microsoft.com/\">Malicious link 4</a>");
		tester.setTextField("sitemessage", "<a href=\"http://www.microsoft.com/\">Malicious link 5</a>");
	...
	public void testVulnerability111(){
		...
		tester.setHiddenField("schoolname", "<a href=\"http://www.microsoft.com/\">Malicious link</a>"); //max 50 chars
	...
	public void testVulnerability200(){
		...
		tester.setHiddenField("selectclass", "<a href=\"http://www.microsoft.com/\">Malicious link</a>");
		tester.clickLinkWithText("Grades");
		tester.assertMatch("Manage Grades");
	...
	public void testVulnerability257(){
        ...
        tester.clickButtonWithText("Add Assignments");
